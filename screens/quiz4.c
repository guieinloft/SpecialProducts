...
Question *quiz4_question_13_create();
...
Question *quiz4_question_1_7_create(bool inverted) {
    ...
    return question_create(a, b, c, text1, text2, text3, false);
}
...
Question *quiz4_question_13_create() {
    ...
    return question_create(a, b, c, text1, text2, text3, true);
}
...
Question *quiz4_question_n_create(int n) {
    switch(n) {
        ...
        case 12:
        return quiz4_question_13_create();
        default:
        return NULL;
    }
}
